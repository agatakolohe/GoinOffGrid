...
const TrailInfoForm = (props) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      />
      <div>
        <label>Have you done this hike before?</label>
        <div>
          <label>
            <Field name="newTrail" component="input" type="radio" value="yes" />{" "}
            Yes
          </label>
          <label>
            <Field name="newTrail" component="input" type="radio" value="no" />{" "}
            No
          </label>
        </div>
      </div>
      ...
      <Field
        ...
        type="text"
        component={renderField}
        label="Estimated Duration of Hike:"
      ...
      <Field
        ...
        type="text"
        component="textarea"
        label="Current Trail Conditions:"
